...
if not client_id or not client_secret:
    raise Exception("Please set SPOTIFY_CLIENT_ID and SPOTIFY_CLIENT_SECRET environment variables")

auth_manager = SpotifyClientCredentials('a9db54421aa243809740798d34c6cdda','c61dd918312844469ea2ca6f6e189ca3')
